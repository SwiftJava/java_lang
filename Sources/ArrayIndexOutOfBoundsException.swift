...
open class ArrayIndexOutOfBoundsException: IndexOutOfBoundsException {
    ...
    public convenience init?( casting object: JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.lang.ArrayIndexOutOfBoundsException", file, line ) {
            return nil
        }
    ...
    private static var ArrayIndexOutOfBoundsExceptionJNIClass: jclass?
