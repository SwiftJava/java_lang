...
open class Process: java_swift.JavaObject {
    ...
    private static var isAlive_MethodID_3: jmethodID?

    open func isAlive() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isAlive", methodSig: "()Z", methodCache: &Process.isAlive_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var getInputStream_MethodID_4: jmethodID?

    open func getInputStream() -> /* java.io.InputStream */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getInputStream", methodSig: "()Ljava/io/InputStream;", methodCache: &Process.getInputStream_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var getOutputStream_MethodID_5: jmethodID?

    open func getOutputStream() -> /* java.io.OutputStream */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getOutputStream", methodSig: "()Ljava/io/OutputStream;", methodCache: &Process.getOutputStream_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getErrorStream_MethodID_6: jmethodID?

    open func getErrorStream() -> /* java.io.InputStream */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getErrorStream", methodSig: "()Ljava/io/InputStream;", methodCache: &Process.getErrorStream_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* java.io.InputStream */ UnclassedObject( javaObject: __return ) : nil
    }
    ...
    private static var waitFor_MethodID_7: jmethodID?

    open func waitFor( timeout: Int64, unit: /* java.util.concurrent.TimeUnit */ UnclassedObject? ) throws /* java.lang.InterruptedException */ -> Bool {
    ...
    open func waitFor( _ _timeout: Int64, _ _unit: /* java.util.concurrent.TimeUnit */ UnclassedObject? ) throws /* java.lang.InterruptedException */ -> Bool {
    ...
    private static var waitFor_MethodID_8: jmethodID?

    open func waitFor() throws /* java.lang.InterruptedException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "waitFor", methodSig: "()I", methodCache: &Process.waitFor_MethodID_8, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw InterruptedException( javaObject: throwable )
        }
    ...
    private static var exitValue_MethodID_9: jmethodID?

    open func exitValue() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "exitValue", methodSig: "()I", methodCache: &Process.exitValue_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var destroyForcibly_MethodID_10: jmethodID?

    open func destroyForcibly() -> Process! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "destroyForcibly", methodSig: "()Ljava/lang/Process;", methodCache: &Process.destroyForcibly_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
