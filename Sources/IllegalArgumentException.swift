...
open class IllegalArgumentException: RuntimeException {
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/IllegalArgumentException", classCache: &IllegalArgumentException.IllegalArgumentExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &IllegalArgumentException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( message: String?, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/IllegalArgumentException", classCache: &IllegalArgumentException.IllegalArgumentExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &IllegalArgumentException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( s: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/IllegalArgumentException", classCache: &IllegalArgumentException.IllegalArgumentExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &IllegalArgumentException.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/lang/IllegalArgumentException", classCache: &IllegalArgumentException.IllegalArgumentExceptionJNIClass, methodSig: "()V", methodCache: &IllegalArgumentException.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
