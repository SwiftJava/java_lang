...
open class ThreadInfo: JavaObject {

    public convenience init?( casting object: JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.lang.management.ThreadInfo", file, line ) {
            return nil
        }
    ...
    open class func from( arg0: /* javax.management.openmbean.CompositeData */ UnclassedProtocol? ) -> ThreadInfo! {
    ...
    open class func from( _ _arg0: /* javax.management.openmbean.CompositeData */ UnclassedProtocol? ) -> ThreadInfo! {
        return from( arg0: _arg0 )
    }

    /// public java.lang.StackTraceElement[] java.lang.management.ThreadInfo.getStackTrace()

    private static var getStackTrace_MethodID_2: jmethodID?

    open func getStackTrace() -> [StackTraceElement]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getStackTrace", methodSig: "()[Ljava/lang/StackTraceElement;", methodCache: &ThreadInfo.getStackTrace_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getLockInfo_MethodID_10: jmethodID?

    open func getLockInfo() -> LockInfo! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLockInfo", methodSig: "()Ljava/lang/management/LockInfo;", methodCache: &ThreadInfo.getLockInfo_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getLockName_MethodID_11: jmethodID?

    open func getLockName() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLockName", methodSig: "()Ljava/lang/String;", methodCache: &ThreadInfo.getLockName_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.decode( type: String(), from: __return )
    }
    ...
    private static var getLockOwnerId_MethodID_12: jmethodID?

    open func getLockOwnerId() -> Int64 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallLongMethod( object: javaObject, methodName: "getLockOwnerId", methodSig: "()J", methodCache: &ThreadInfo.getLockOwnerId_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int64(), from: __return )
    }
    ...
    private static var getLockOwnerName_MethodID_13: jmethodID?

    open func getLockOwnerName() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLockOwnerName", methodSig: "()Ljava/lang/String;", methodCache: &ThreadInfo.getLockOwnerName_MethodID_13, args: &__args, locals: &__locals )
        return JNIType.decode( type: String(), from: __return )
    }
    ...
    private static var isSuspended_MethodID_14: jmethodID?

    open func isSuspended() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSuspended", methodSig: "()Z", methodCache: &ThreadInfo.isSuspended_MethodID_14, args: &__args, locals: &__locals )
    ...
    private static var isInNative_MethodID_15: jmethodID?

    open func isInNative() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isInNative", methodSig: "()Z", methodCache: &ThreadInfo.isInNative_MethodID_15, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var getLockedMonitors_MethodID_16: jmethodID?

    open func getLockedMonitors() -> [MonitorInfo]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLockedMonitors", methodSig: "()[Ljava/lang/management/MonitorInfo;", methodCache: &ThreadInfo.getLockedMonitors_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.decode( type: [MonitorInfo](), from: __return )
    }


    /// public java.lang.management.LockInfo[] java.lang.management.ThreadInfo.getLockedSynchronizers()

    private static var getLockedSynchronizers_MethodID_17: jmethodID?

    open func getLockedSynchronizers() -> [LockInfo]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLockedSynchronizers", methodSig: "()[Ljava/lang/management/LockInfo;", methodCache: &ThreadInfo.getLockedSynchronizers_MethodID_17, args: &__args, locals: &__locals )
        return JNIType.decode( type: [LockInfo](), from: __return )
    }
