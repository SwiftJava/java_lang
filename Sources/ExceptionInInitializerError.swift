...
open class ExceptionInInitializerError: LinkageError {
    ...
    public convenience init?( casting object: JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.lang.ExceptionInInitializerError", file, line ) {
            return nil
        }
    ...
    public convenience init( arg0: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/ExceptionInInitializerError", classCache: &ExceptionInInitializerError.ExceptionInInitializerErrorJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &ExceptionInInitializerError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
