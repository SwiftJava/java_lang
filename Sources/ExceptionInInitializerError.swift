...
open class ExceptionInInitializerError: LinkageError {
    ...
    public convenience init( s: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/ExceptionInInitializerError", classCache: &ExceptionInInitializerError.ExceptionInInitializerErrorJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &ExceptionInInitializerError.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/lang/ExceptionInInitializerError", classCache: &ExceptionInInitializerError.ExceptionInInitializerErrorJNIClass, methodSig: "()V", methodCache: &ExceptionInInitializerError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
