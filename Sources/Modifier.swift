...
open class Modifier: java_swift.JavaObject {
    ...
    open class func toString( mod: Int ) -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
    ...
    private static var classModifiers_MethodID_4: jmethodID?

    open class func classModifiers() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "classModifiers", methodSig: "()I", methodCache: &classModifiers_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var isAbstract_MethodID_5: jmethodID?

    open class func isAbstract( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isAbstract", methodSig: "(I)Z", methodCache: &isAbstract_MethodID_5, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isStatic_MethodID_6: jmethodID?

    open class func isStatic( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isStatic", methodSig: "(I)Z", methodCache: &isStatic_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isProtected_MethodID_7: jmethodID?

    open class func isProtected( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isProtected", methodSig: "(I)Z", methodCache: &isProtected_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var methodModifiers_MethodID_8: jmethodID?

    open class func methodModifiers() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "methodModifiers", methodSig: "()I", methodCache: &methodModifiers_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var constructorModifiers_MethodID_9: jmethodID?

    open class func constructorModifiers() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "constructorModifiers", methodSig: "()I", methodCache: &constructorModifiers_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var isFinal_MethodID_10: jmethodID?

    open class func isFinal( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isFinal", methodSig: "(I)Z", methodCache: &isFinal_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isPublic_MethodID_11: jmethodID?

    open class func isPublic( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isPublic", methodSig: "(I)Z", methodCache: &isPublic_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isVolatile_MethodID_12: jmethodID?

    open class func isVolatile( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isVolatile", methodSig: "(I)Z", methodCache: &isVolatile_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isPrivate_MethodID_13: jmethodID?

    open class func isPrivate( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isPrivate", methodSig: "(I)Z", methodCache: &isPrivate_MethodID_13, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isNative_MethodID_14: jmethodID?

    open class func isNative( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isNative", methodSig: "(I)Z", methodCache: &isNative_MethodID_14, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isStrict_MethodID_17: jmethodID?

    open class func isStrict( mod: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: mod, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "isStrict", methodSig: "(I)Z", methodCache: &isStrict_MethodID_17, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var interfaceModifiers_MethodID_18: jmethodID?

    open class func interfaceModifiers() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "interfaceModifiers", methodSig: "()I", methodCache: &interfaceModifiers_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var fieldModifiers_MethodID_19: jmethodID?

    open class func fieldModifiers() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "fieldModifiers", methodSig: "()I", methodCache: &fieldModifiers_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var parameterModifiers_MethodID_20: jmethodID?

    open class func parameterModifiers() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/reflect/Modifier", classCache: &ModifierJNIClass, methodName: "parameterModifiers", methodSig: "()I", methodCache: &parameterModifiers_MethodID_20, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
