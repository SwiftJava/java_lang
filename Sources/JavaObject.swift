...
open class JavaObject: JNIObject {
    ...
    public convenience init?( casting object: JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.lang.Object", file, line ) {
            return nil
        }
    ...
    open func wait() throws /* java.lang.InterruptedException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "wait", methodSig: "()V", methodCache: &JavaObject.wait_MethodID_3, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
    ...
    open func wait( arg0: Int64, arg1: Int ) throws /* java.lang.InterruptedException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "wait", methodSig: "(JI)V", methodCache: &JavaObject.wait_MethodID_5, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw InterruptedException( javaObject: throwable )
        }
    }
