...
open class ClassNotFoundException: ReflectiveOperationException {
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/lang/ClassNotFoundException", classCache: &ClassNotFoundException.ClassNotFoundExceptionJNIClass, methodSig: "()V", methodCache: &ClassNotFoundException.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
