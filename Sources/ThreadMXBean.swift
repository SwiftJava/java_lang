...
open class ThreadMXBeanForward: PlatformManagedObjectForward, ThreadMXBean {
    ...
    open func getThreadInfo( ids: [Int64]?, lockedMonitors: Bool, lockedSynchronizers: Bool ) -> [ThreadInfo]! {
        ...
        __args[1] = JNIType.toJava( value: lockedMonitors, locals: &__locals )
        __args[2] = JNIType.toJava( value: lockedSynchronizers, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getThreadInfo", methodSig: "([JZZ)[Ljava/lang/management/ThreadInfo;", methodCache: &ThreadMXBeanForward.getThreadInfo_MethodID_33, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [ThreadInfo](), from: __return )
    }
    ...
    open func getThreadInfo( ids: [Int64]?, maxDepth: Int ) -> [ThreadInfo]! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ids, locals: &__locals )
        __args[1] = JNIType.toJava( value: maxDepth, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getThreadInfo", methodSig: "([JI)[Ljava/lang/management/ThreadInfo;", methodCache: &ThreadMXBeanForward.getThreadInfo_MethodID_34, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [ThreadInfo](), from: __return )
    }
    ...
    open func getThreadInfo( id: Int64, maxDepth: Int ) -> ThreadInfo! {
        ...
        __args[1] = JNIType.toJava( value: maxDepth, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getThreadInfo", methodSig: "(JI)Ljava/lang/management/ThreadInfo;", methodCache: &ThreadMXBeanForward.getThreadInfo_MethodID_35, args: &__args, locals: &__locals )
    ...
    open func getThreadInfo( id: Int64 ) -> ThreadInfo! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: id, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getThreadInfo", methodSig: "(J)Ljava/lang/management/ThreadInfo;", methodCache: &ThreadMXBeanForward.getThreadInfo_MethodID_36, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? ThreadInfo( javaObject: __return ) : nil
    }
    ...
    open func getThreadInfo( ids: [Int64]? ) -> [ThreadInfo]! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ids, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getThreadInfo", methodSig: "([J)[Ljava/lang/management/ThreadInfo;", methodCache: &ThreadMXBeanForward.getThreadInfo_MethodID_37, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [ThreadInfo](), from: __return )
    }
    ...
    open func dumpAllThreads( lockedMonitors: Bool, lockedSynchronizers: Bool ) -> [ThreadInfo]! {
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: lockedMonitors, locals: &__locals )
        __args[1] = JNIType.toJava( value: lockedSynchronizers, locals: &__locals )
