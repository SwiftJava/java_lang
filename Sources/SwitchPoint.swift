...
open class SwitchPoint: java_swift.JavaObject {
    ...
    private static var hasBeenInvalidated_MethodID_2: jmethodID?

    open func hasBeenInvalidated() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "hasBeenInvalidated", methodSig: "()Z", methodCache: &SwitchPoint.hasBeenInvalidated_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var invalidateAll_MethodID_3: jmethodID?

    open class func invalidateAll( switchPoints: [SwitchPoint]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: switchPoints, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "java/lang/invoke/SwitchPoint", classCache: &SwitchPointJNIClass, methodName: "invalidateAll", methodSig: "([Ljava/lang/invoke/SwitchPoint;)V", methodCache: &invalidateAll_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var guardWithTest_MethodID_4: jmethodID?
    ...
    open func guardWithTest( target: MethodHandle?, fallback: MethodHandle? ) -> MethodHandle! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "guardWithTest", methodSig: "(Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodHandle;)Ljava/lang/invoke/MethodHandle;", methodCache: &SwitchPoint.guardWithTest_MethodID_4, args: &__args, locals: &__locals )
