...
open class GenericSignatureFormatError: ClassFormatError {
    ...
    /// private static final long java.lang.reflect.GenericSignatureFormatError.serialVersionUID

    /// private static final long java.lang.ClassFormatError.serialVersionUID
    ...
    public convenience init( message: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/reflect/GenericSignatureFormatError", classCache: &GenericSignatureFormatError.GenericSignatureFormatErrorJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &GenericSignatureFormatError.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
