...
open class PlatformLoggingMXBeanForward: PlatformManagedObjectForward, PlatformLoggingMXBean {
    ...
    private static var setLoggerLevel_MethodID_5: jmethodID?
    ...
    open func setLoggerLevel( loggerName: String?, levelName: String? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLoggerLevel", methodSig: "(Ljava/lang/String;Ljava/lang/String;)V", methodCache: &PlatformLoggingMXBeanForward.setLoggerLevel_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var getParentLoggerName_MethodID_6: jmethodID?

    open func getParentLoggerName( loggerName: String? ) -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: loggerName, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getParentLoggerName", methodSig: "(Ljava/lang/String;)Ljava/lang/String;", methodCache: &PlatformLoggingMXBeanForward.getParentLoggerName_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: String(), from: __return )
    }
