...
open class Package: java_swift.JavaObject, AnnotatedElement {
    ...
    open func getAnnotations() -> [Annotation]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAnnotations", methodSig: "()[Ljava/lang/annotation/Annotation;", methodCache: &Package.getAnnotations_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [AnnotationForward](), from: __return )
    }
    ...
    open func getDeclaredAnnotations() -> [Annotation]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDeclaredAnnotations", methodSig: "()[Ljava/lang/annotation/Annotation;", methodCache: &Package.getDeclaredAnnotations_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [AnnotationForward](), from: __return )
    }
    ...
    private static var getPackages_MethodID_10: jmethodID?

    open class func getPackages() -> [Package]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/lang/Package", classCache: &PackageJNIClass, methodName: "getPackages", methodSig: "()[Ljava/lang/Package;", methodCache: &getPackages_MethodID_10, args: &__args, locals: &__locals )
    ...
    private static var isSealed_MethodID_11: jmethodID?

    open func isSealed() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSealed", methodSig: "()Z", methodCache: &Package.isSealed_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isSealed_MethodID_12: jmethodID?
    ...
    open func isSealed( _ _url: /* java.net.URL */ UnclassedObject? ) -> Bool {
