...
open class JavaError: java_swift.Throwable {
    ...
    private static var JavaErrorJNIClass: jclass?
    ...
    public convenience init( arg0: String?, arg1: java_swift.Throwable?, arg2: Bool, arg3: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;ZZ)V", methodCache: &JavaError.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( arg0: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &JavaError.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: java_swift.Throwable? ) {
        ...
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1 != nil ? arg1! as JNIObject : nil, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &JavaError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &JavaError.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "()V", methodCache: &JavaError.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
