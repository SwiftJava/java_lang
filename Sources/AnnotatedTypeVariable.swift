...
public protocol AnnotatedTypeVariable: AnnotatedType {
...
open class AnnotatedTypeVariableForward: AnnotatedTypeForward, AnnotatedTypeVariable {

    private static var AnnotatedTypeVariableJNIClass: jclass?

    /// public abstract java.lang.reflect.AnnotatedType[] java.lang.reflect.AnnotatedTypeVariable.getAnnotatedBounds()

    private static var getAnnotatedBounds_MethodID_2: jmethodID?

    open func getAnnotatedBounds() -> [AnnotatedType]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAnnotatedBounds", methodSig: "()[Ljava/lang/reflect/AnnotatedType;", methodCache: &AnnotatedTypeVariableForward.getAnnotatedBounds_MethodID_2, args: &__args, locals: &__locals )
    ...
    override open func getType() -> Type! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getType", methodSig: "()Ljava/lang/reflect/Type;", methodCache: &AnnotatedTypeVariableForward.getType_MethodID_3, args: &__args, locals: &__locals )
    ...
    override open func getAnnotation( arg0: java_swift.JavaClass? ) -> Annotation! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAnnotation", methodSig: "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", methodCache: &AnnotatedTypeVariableForward.getAnnotation_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func isAnnotationPresent( arg0: java_swift.JavaClass? ) -> Bool {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isAnnotationPresent", methodSig: "(Ljava/lang/Class;)Z", methodCache: &AnnotatedTypeVariableForward.isAnnotationPresent_MethodID_5, args: &__args, locals: &__locals )
    ...
    override open func getAnnotationsByType( arg0: java_swift.JavaClass? ) -> [Annotation]! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAnnotationsByType", methodSig: "(Ljava/lang/Class;)[Ljava/lang/annotation/Annotation;", methodCache: &AnnotatedTypeVariableForward.getAnnotationsByType_MethodID_6, args: &__args, locals: &__locals )
    ...
    override open func getAnnotations() -> [Annotation]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAnnotations", methodSig: "()[Ljava/lang/annotation/Annotation;", methodCache: &AnnotatedTypeVariableForward.getAnnotations_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [AnnotationForward](), from: __return )
    }
    ...
    override open func getDeclaredAnnotation( arg0: java_swift.JavaClass? ) -> Annotation! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDeclaredAnnotation", methodSig: "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", methodCache: &AnnotatedTypeVariableForward.getDeclaredAnnotation_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? AnnotationForward( javaObject: __return ) : nil
    }
    ...
    override open func getDeclaredAnnotationsByType( arg0: java_swift.JavaClass? ) -> [Annotation]! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDeclaredAnnotationsByType", methodSig: "(Ljava/lang/Class;)[Ljava/lang/annotation/Annotation;", methodCache: &AnnotatedTypeVariableForward.getDeclaredAnnotationsByType_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [AnnotationForward](), from: __return )
    }
    ...
    override open func getDeclaredAnnotations() -> [Annotation]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDeclaredAnnotations", methodSig: "()[Ljava/lang/annotation/Annotation;", methodCache: &AnnotatedTypeVariableForward.getDeclaredAnnotations_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [AnnotationForward](), from: __return )
    }
