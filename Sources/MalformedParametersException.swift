...
open class MalformedParametersException: RuntimeException {
    ...
    private static var MalformedParametersExceptionJNIClass: jclass?

    /// private static final long java.lang.reflect.MalformedParametersException.serialVersionUID
    ...
    /// public java.lang.reflect.MalformedParametersException()
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/reflect/MalformedParametersException", classCache: &MalformedParametersException.MalformedParametersExceptionJNIClass, methodSig: "()V", methodCache: &MalformedParametersException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( reason: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/reflect/MalformedParametersException", classCache: &MalformedParametersException.MalformedParametersExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &MalformedParametersException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
