...
public protocol Instrumentation: JavaProtocol {
    ...
    func appendToBootstrapClassLoaderSearch( jarfile: /* java.util.jar.JarFile */ UnclassedObject? )

    /// public abstract void java.lang.instrument.Instrumentation.appendToSystemClassLoaderSearch(java.util.jar.JarFile)

    func appendToSystemClassLoaderSearch( jarfile: /* java.util.jar.JarFile */ UnclassedObject? )
...
open class InstrumentationForward: JNIObjectForward, Instrumentation {
    ...
    open func addTransformer( transformer: ClassFileTransformer?, canRetransform: Bool ) {
        ...
        __args[1] = JNIType.toJava( value: canRetransform, locals: &__locals )
    ...
    open func appendToBootstrapClassLoaderSearch( _ _jarfile: /* java.util.jar.JarFile */ UnclassedObject? ) {
    ...
    open func appendToSystemClassLoaderSearch( _ _jarfile: /* java.util.jar.JarFile */ UnclassedObject? ) {
