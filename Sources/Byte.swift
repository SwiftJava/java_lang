...
open class Byte: Number, JavaComparable {
    ...
    open func equals( obj: java_swift.JavaObject? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "equals", methodSig: "(Ljava/lang/Object;)Z", methodCache: &Byte.equals_MethodID_3, args: &__args, locals: &__locals )
    ...
    open class func toString( b: Int8 ) -> String! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "toString", methodSig: "(B)Ljava/lang/String;", methodCache: &toString_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func compareTo( anotherByte: Byte? ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: anotherByte != nil ? anotherByte! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "compareTo", methodSig: "(Ljava/lang/Byte;)I", methodCache: &Byte.compareTo_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func compareTo( arg0: java_swift.JavaObject? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "compareTo", methodSig: "(Ljava/lang/Object;)I", methodCache: &Byte.compareTo_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open class func valueOf( s: String? ) throws /* java.lang.NumberFormatException */ -> Byte! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: s, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "valueOf", methodSig: "(Ljava/lang/String;)Ljava/lang/Byte;", methodCache: &valueOf_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw NumberFormatException( javaObject: throwable )
        }
    ...
    open class func valueOf( s: String?, radix: Int ) throws /* java.lang.NumberFormatException */ -> Byte! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "valueOf", methodSig: "(Ljava/lang/String;I)Ljava/lang/Byte;", methodCache: &valueOf_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw NumberFormatException( javaObject: throwable )
        }
    ...
    private static var decode_MethodID_11: jmethodID?
    ...
    open class func decode( nm: String? ) throws /* java.lang.NumberFormatException */ -> Byte! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "decode", methodSig: "(Ljava/lang/String;)Ljava/lang/Byte;", methodCache: &decode_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw NumberFormatException( javaObject: throwable )
        }
    ...
    open class func compare( x: Int8, y: Int8 ) -> Int {
        ...
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "compare", methodSig: "(BB)I", methodCache: &compare_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var parseByte_MethodID_13: jmethodID?
    ...
    open class func parseByte( s: String?, radix: Int ) throws /* java.lang.NumberFormatException */ -> Int8 {
        ...
        __args[0] = JNIType.toJava( value: s, locals: &__locals )
        __args[1] = JNIType.toJava( value: radix, locals: &__locals )
        let __return = JNIMethod.CallStaticByteMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "parseByte", methodSig: "(Ljava/lang/String;I)B", methodCache: &parseByte_MethodID_13, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw NumberFormatException( javaObject: throwable )
        }
    ...
    private static var parseByte_MethodID_14: jmethodID?

    open class func parseByte( s: String? ) throws /* java.lang.NumberFormatException */ -> Int8 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: s, locals: &__locals )
        let __return = JNIMethod.CallStaticByteMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "parseByte", methodSig: "(Ljava/lang/String;)B", methodCache: &parseByte_MethodID_14, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw NumberFormatException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int8(), from: __return )
    ...
    private static var toUnsignedInt_MethodID_15: jmethodID?

    open class func toUnsignedInt( x: Int8 ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "toUnsignedInt", methodSig: "(B)I", methodCache: &toUnsignedInt_MethodID_15, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var toUnsignedLong_MethodID_16: jmethodID?

    open class func toUnsignedLong( x: Int8 ) -> Int64 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        let __return = JNIMethod.CallStaticLongMethod( className: "java/lang/Byte", classCache: &ByteJNIClass, methodName: "toUnsignedLong", methodSig: "(B)J", methodCache: &toUnsignedLong_MethodID_16, args: &__args, locals: &__locals )
