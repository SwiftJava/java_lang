...
open class MemoryType: Enum {
    ...
    public convenience init?( casting object: JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.lang.management.MemoryType", file, line ) {
            return nil
        }
    ...
    open class func values() -> [MemoryType]! {
        ...
        return JNIType.decode( type: [MemoryType](), from: __return )
    }
    ...
    open class func valueOf( arg0: String? ) -> MemoryType! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
    ...
    open class func valueOf( _ _arg0: String? ) -> MemoryType! {
