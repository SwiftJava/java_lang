...
open class InternalError: VirtualMachineError {
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/InternalError", classCache: &InternalError.InternalErrorJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &InternalError.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( message: String?, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/InternalError", classCache: &InternalError.InternalErrorJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &InternalError.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( message: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: message, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/InternalError", classCache: &InternalError.InternalErrorJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &InternalError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/lang/InternalError", classCache: &InternalError.InternalErrorJNIClass, methodSig: "()V", methodCache: &InternalError.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
