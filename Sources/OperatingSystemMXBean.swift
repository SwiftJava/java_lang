...
public protocol OperatingSystemMXBean: JavaProtocol {
...
open class OperatingSystemMXBeanForward: JNIObjectForward, OperatingSystemMXBean {
    ...
    private static var getVersion_MethodID_7: jmethodID?

    open func getVersion() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getVersion", methodSig: "()Ljava/lang/String;", methodCache: &OperatingSystemMXBeanForward.getVersion_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.decode( type: String(), from: __return )
    }
    ...
    private static var getArch_MethodID_8: jmethodID?

    open func getArch() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getArch", methodSig: "()Ljava/lang/String;", methodCache: &OperatingSystemMXBeanForward.getArch_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.decode( type: String(), from: __return )
    }
