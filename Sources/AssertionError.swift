...
open class AssertionError: JavaError {
    ...
    public convenience init( detailMessage: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "(I)V", methodCache: &AssertionError.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( detailMessage: Int64 ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: detailMessage, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "(J)V", methodCache: &AssertionError.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( detailMessage: Float ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: detailMessage, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "(F)V", methodCache: &AssertionError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( detailMessage: Double ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: detailMessage, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "(D)V", methodCache: &AssertionError.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "()V", methodCache: &AssertionError.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( detailMessage: Bool ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: detailMessage, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "(Z)V", methodCache: &AssertionError.new_MethodID_8, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( detailMessage: UInt16 ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: detailMessage, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/AssertionError", classCache: &AssertionError.AssertionErrorJNIClass, methodSig: "(C)V", methodCache: &AssertionError.new_MethodID_9, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
